**Title:** Star Citizen Alpha 3.8.1g PTU.4390653 Patch Notes
**Date:** 2020-02-07
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-8-1g-ptu-4390653-patch-notes

---

# Star Citizen Patch 3.8.1g
Alpha Patch 3.8.1g has been released to PTU, and is now available to test!   Patch should now show: VERSION 3.8.1-PTU.4390653.
...
## Bug Fixes
- Harvestables should no longer be able to be duplicated when stowing in inventory and changing armor.
- Players should no longer get an infinite load or a 30009 error when using bed logout and returning to the game.
Technical
