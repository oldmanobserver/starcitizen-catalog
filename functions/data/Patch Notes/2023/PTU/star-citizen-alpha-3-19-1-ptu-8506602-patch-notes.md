**Title:** Star Citizen Alpha 3.19.1 PTU.8506602 Patch Notes
**Date:** 2023-05-30
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-19-1-ptu-8503251-patch-notes

---

# Star Citizen Patch 3.19.1 8506602
Alpha Patch 3.19.1 has been released to the PTU, and is now available to test! Patch should now show: VERSION 3.19.1-PTU.8506602.
...
# Bug Fixes
- Fixed an issue causing many NPCs to duplicate around the PU
- Fixed - UI - Inner Thought - mobiGlas - If the player unequips the mobiGlas and loses it, they are unable to purchase a new one meaning mobiGlas features are not accessible
# Technical
- Fixed 1 Client Crash
- Fixed 2 Server Crashes
- Made Backend Service Stability Improvements