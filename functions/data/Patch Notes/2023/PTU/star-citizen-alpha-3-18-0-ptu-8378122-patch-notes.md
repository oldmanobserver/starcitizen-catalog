**Title:** Star Citizen Alpha 3.18.0 PTU.8378122 Patch Notes
**Date:** 2023-02-23
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-18-0-ptu-8378122-patch-notes

---

# Star Citizen Patch 3.18.0-PTU.8378122
Alpha Patch VERSION 3.18.0-PTU.8378122 has been released to the PTU, and is now available to test!
...
# Bug Fixes
There have been many more elevator fixes put into today's build that should greatly improve the experience across the PU
-     Fixed - Client - Crash - Crash Handler - If the client crashes, it does not prompt a crash handler for the player
-     Fixed - ASOP Terminal / Ships - Claiming - When claiming a rented ship for the first time the delivery timer will be incorrect this causes an error message to appear
-     Fixed - Mining - Ship mining laser on mineable rocks below 1k mass at 0% energy level continues to fill up charge level.
-     Fixed - New Babbage – Transit – Player is unable to enter the metro loop train
-     Fixed - Design / Transit / Locations - Players are unable to call elevators from rest stop refinery
-     Fixed - Design / Transit / Location - The player is unable to call elevator from hangar interiors
-     Fixed - Art - Artimex Helmet's respiratory tube is unattached
-     Fixed - EXPLOIT - Insurance / Economy / UI - ASOP - Claimed rental ships become functionally identical to owned player ships
