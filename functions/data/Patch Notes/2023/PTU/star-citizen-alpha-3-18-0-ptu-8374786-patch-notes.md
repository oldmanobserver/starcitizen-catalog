**Title:** Star Citizen Alpha 3.18.0 PTU.8374786 Patch Notes
**Date:** 2023-02-20
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-18-0-ptu-8374786-patch-notes

---

# Star Citizen Patch 3.18.0-PTU.8374786
Alpha Patch VERSION 3.18.0-PTU.8374786 has been released to the PTU, and is now available to test!
...
**Testing Focus**
This build has extra server logging to help track down multiple server issues that we are tracking
...
**Known Issues**
- Insurance / UI - Kiosks - ASOP - Ships - All RSI Constellation variants with snub docking do not appear on ASOP terminal
...
# Bug Fixes
-     Fixed - Multivehicle - Vehicles / Bindings - "Reset to SCM" binding sets vehicle speed to ~80% of the vehicles top-speed instead of the vehicles max SCM speed
# Technical
