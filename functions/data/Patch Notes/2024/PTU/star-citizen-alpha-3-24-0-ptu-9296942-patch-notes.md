**Title:** Star Citizen Alpha 3.24.0 PTU.9296942  Patch Notes
**Date:** 2024-08-27
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-24-0-ptu-patch-notes-20

---

# Star Citizen Alpha Patch 3.24.0
Alpha Patch 3.24.0 has been released to PTU, and is now available to test!   Patch should now show: VERSION 3.24.0-PTU.9296942.
...
# Features & Gameplay
Gameplay
-     Removed the Ability to Salvage While in Instanced Hangars
Core Tech
-     New LTP Additions
Hangar decorations, commodity containers, and mining gadgets are all now saved in LTP. With this update, items placed to decorate personal hangars will be reset back into your local inventory during updates.


# Bug Fixes
-     Fixed an issue causing player elevator panels in hangars to go missing
# Technical
