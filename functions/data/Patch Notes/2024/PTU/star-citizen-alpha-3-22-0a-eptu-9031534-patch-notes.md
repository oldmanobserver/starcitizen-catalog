**Title:** Star Citizen Alpha 3.22.0a EPTU.9031534 Patch Notes
**Date:** 2024-01-19
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-22-0a-eptu-9031534-patch-note

---

# Star Citizen Patch 3.22.0a
Alpha Patch 3.22.0a has been released to the EPTU, and is now available to test! Patch should now show: VERSION 3.22.0-EPTU.9031534.
...
-     Stability
-     Siege of Orison 
SoO start time is TDB as we test further issues. We plan on running it this weekend if possible
...
# Bug Fixes
-     Fixed multiple issues causing shuttle transit to stop and become stranded before reaching a destination
-     Siege: Fixed - PU - Missions - Siege of Orison - SoO barge missing on admin platform
-     Siege: Fixed - Turrets do not take over faction change from SecurityManifest change
-     Siege: Fixed - PU - Missions / AI - SOO - AI will occasionally slide when moving in and out of cover
-     Siege: Fixed - PU - Stanton - SOO - Mission Content / AI - Spawn closets located at Barge are not spawning AI correctly
-     Siege: Fixed - PU - Stanton - SOO - Mission Content / UI - Eliminating an Island Boss before their marker appears can cause mission objectives can fail to update from that point onwards
-     Siege: Fixed - PU - Stanton - SOO - Mission Content / Vehicles / Law - Players are able to fly Crusader Ships out of the mission area
-     Siege: Fixed - PU - Stanton - SOO - Mission Content / AI - AI behaviour is incorrect in spawn closets