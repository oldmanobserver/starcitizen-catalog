**Title:** Star Citizen Alpha 3.22.0a EPTU.9033691 Patch Notes
**Date:** 2024-01-22
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-22-0a-eptu-9033691-patch-note

---

# Star Citizen Patch 3.22.0a
Alpha Patch 3.22.0a has been released to the EPTU, and is now available to test! Patch should now show: VERSION 3.22.0-EPTU.9033691.
...
- Stability
- Siege of Orison
Siege will start shortly after the build is out and is intended to run overnight
...
# Bug Fixes
- Siege: Fixed - PU - Stanton - Siege Of Orison - Spawn Closets will remain open with no enemies inside oh Hartmore Platform
