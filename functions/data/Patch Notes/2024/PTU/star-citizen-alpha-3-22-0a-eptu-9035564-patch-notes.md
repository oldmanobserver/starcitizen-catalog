**Title:** Star Citizen Alpha 3.22.0a EPTU.9035564 Patch Notes
**Date:** 2024-01-24
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-22-0a-eptu-9035564-patch-note

---

# Star Citizen Patch 3.22.0a
Alpha Patch 3.22.0a has been released to the EPTU, and is now available to test! Patch should now show: VERSION 3.22.0-EPTU.9035564.
...
SoO will start shortly after the build is out and is intended to run overnight on EPTU.
...
# Bug Fixes
-     Siege: Fixed - PU - Stanton - Mission Content - SOO - Island Boss will fail to spawn
-     Siege: Fixed - Stanton - SOO - Mission Content / AI - Lieutenant stuck beneath spawn location