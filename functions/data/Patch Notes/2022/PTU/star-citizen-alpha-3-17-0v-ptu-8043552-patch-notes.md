**Title:** Star Citizen Alpha 3.17.0v PTU.8043552 Patch Notes
**Date:** 2022-04-21
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-17-0v-ptu-8043552-patch-notes

---

# Star Citizen Patch 3.17.0v
Alpha Patch 3.17.0v has been released to the PTU, and is now available to test!   Patch should now show: VERSION 3.17.0-PTU.8043552.
...
# Feature Updates
Gameplay
-     Made further improvements to make engaging quantum travel more consistent
# Bug Fixes
-     Large hangars should no longer be missing collisions
-     There should no longer be double elevators in Centermass at Area18
-     Fixed an issue causing underwater VFX to appear in caves
-     Sabre Raven textures should no longer be incorrect at certain angles
-     Fixed an issue causing terrain to sometimes display square shadow artifacts
# Technical
-     Fixed 9 Client Crashes (fixed ship rental crash)
