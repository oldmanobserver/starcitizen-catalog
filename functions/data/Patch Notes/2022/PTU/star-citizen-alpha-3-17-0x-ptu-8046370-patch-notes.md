**Title:** Star Citizen Alpha 3.17.0x PTU.8046370 Patch Notes
**Date:** 2022-04-25
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-17-0x-ptu-8046370-patch-notes

---

# Star Citizen Patch 3.17.0x
Alpha Patch 3.17.0x has been released to the PTU, and is now available to test!   Patch should now show: VERSION 3.17.0-PTU.8046370.
...
# Bug Fixes
-     Camera should now align and lock in correctly to kiosks and terminals
-     Logging back into a ship bed should now consistently bring players into the PU instead of infinitely loading
-     Fixed an issue causing underwater VFX to appear in UGFs
-     AI pilots should no longer ignore and crash into static obstacles
-     Requesting boost when it can't be turned on no longer starts the regen cooldown
-     Personal inventory capacity should no longer be able to be increased by transferring items to loot crates
-     Cargo should no longer fall out of the back of the Tumbril Cyclone trunk while driving
-     Inner thought Power on/off prompts should no longer be missing in the ARGO MOLE mining turrets
-     ARGO RAFT quantum VFX should no longer be misaligned
-     There should no longer be Replace Me spheres located on Pad 09 and 10 on each strut of Port Olisar
# Technical
