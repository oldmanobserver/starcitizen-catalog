**Title:** Star Citizen Alpha 3.17.0r PTU.8036373 Patch Notes
**Date:** 2022-04-13
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-17-0r-ptu-8036373-patch-notes

---

# Star Citizen Patch 3.17.0r
Alpha Patch 3.17.0r has been released to the PTU, and is now available to test!   Patch should now show: VERSION 3.17.0-PTU.8036373.
...
-     Friends list - Unable to see some accounts when adding to friends list
-     Players HUD spammed with constant assist notifications
-     Custom mobiGlas Casings breaks the mobiGlas functionality
-     Last Held Item Teleports back into your Hand
...
-     Shops are spawning item boxes of purchasable items
# Feature Updates
Gameplay
-     Temporary Rebalance of Inventory Capacities for All Ships
# Bug Fixes
-     Quantum Drive should now engage consistently
-     There should no longer be a VisArea issue between Customs and Traveler Rentals in Riker Memorial Spaceport
-     Area 18 Traveller Rental Kiosk should no longer appear blank when accessed
-     Mining Lasers and consumables should now apply their properties to Mining Deposits
-     Missiles should no longer behave jittery when under heavy server load
-     Origin 85x landing gear should no longer be stuck in hangar floor after spawning
-     Aurora ship interactions should no longer obscure interaction with MFDs
-     Gemini and Behr Sniper Rifle recoil should now be working correctly

# Technical
We updated logic to cause servers to force kick players out of servers after about a minute if the server is detected as deadlocked. This should help avoid players getting stuck in a deadlocked server for extended periods which may cause multiple other issues.
