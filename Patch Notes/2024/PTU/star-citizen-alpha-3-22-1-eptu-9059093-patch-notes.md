**Title:** Star Citizen Alpha 3.22.1 EPTU.9059093 Patch Notes
**Date:** 2024-02-09
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-22-1-eptu-9059093-patch-notes

---

# Star Citizen Patch 3.22.1
Alpha Patch 3.22.1 has been released and is now available to test!   Patch should now show: VERSION 3.22.1-EPTU.9059093.
...
Running tonight and throughout the weekend, there will be a partial dynamic event playtest in the PU!
-     Phase 1 known issue: Stage 1 / Data Heist - Mission Content - Data Heist server upload bars do not progress
...
# Bug Fixes
-     Dynamic Event Fix - Priority mission not appearing for everyone in the mobiGlas
-     Dynamic Event Fix - Mission information will not appear in any of the contract aside from the phase number you're currently on
-     Fixed - PU - Vehicles / Inventory - Esperia Blade has no personal storage
-     Fixed - PU - Stanton - Hurston - Derelict Settlements - Locations / Collisions - The small windmill towers around the derelict settlements are lacking collision

# Arena Commander Updates
-    Mastermodes - Added custom KRIG gun for P-52 Merlin
-  MasterModes - Removed heat from Master Modes energy weapons
-     MasterModes - Reduced boost modifiers on rotation, cut down boost ramp times
- Fixed (Round 2) - AC Mastermodes - Fixed Inconsistent linear limiters between coupled and decoupled
-     Fixed - Audio - AC Grav Race - Map's environment audio is too loud
-     Fixed - AC - Grav Race - Vehicles / Spawning - When loading into a Grav Race players can spawn on top of each other 