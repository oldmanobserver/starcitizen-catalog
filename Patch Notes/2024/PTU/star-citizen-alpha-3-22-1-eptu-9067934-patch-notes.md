**Title:** Star Citizen Alpha 3.22.1 EPTU.9067934 Patch Notes
**Date:** 2024-02-15
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-22-1-eptu-9067934-patch-notes

---

# Star Citizen Patch 3.22.1
Alpha Patch 3.22.1 has been released and is now available to test!   Patch should now show: VERSION 3.22.1-EPTU.9067934.
...
We will be enabling the new Overdrive Dynamic Event tonight shortly after release to the EPTU and run overnight
...
# Bug Fixes
-     Dynamic Event Fix: PU - Stanton - Pre-Xenothreat - Stage 3 - After completing Overdrive Initiative: Xenothreat incursion reset timer is inconsistent
-     Dynamic Event Fix: PU - Stanton - Pre-Xenothreat - Stage 4 - Missions - After inserting the provided Tigerclaw Cryptokey into the mainframe at Kareah, it is destroyed but not removed from the slot, preventing further cryptokeys from being inserted
-     Dynamic Event Fix: Fixed issue where the initially spawned ships would cause the CommArray to prematurely stream in, stream out and then restream back in, causing issues with mines spawning

# Arena Commander Updates
-     Master Modes: Fixed input axis ranges in master modes 

# Technical
This build contains further memory logging to find issues related to server and client crashes during the Idris battle
