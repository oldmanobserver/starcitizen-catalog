**Title:** Star Citizen Alpha 3.22.0a EPTU.9017427 Patch Notes
**Date:** 2024-01-10
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-22-0a-ptu-9017427-patch-notes

---

# Star Citizen Patch 3.22.0a
Alpha Patch 3.22.0a has been released to the EPTU, and is now available to test! Patch should now show: VERSION 3.22.0-EPTU.9017427.
...
- AC - UI - "Press X When Ready" prompt does not appear at beginning of match
- AC - Vehicles / Components / UI - Equipping a rented component on ship will unequip/change all
- AEGIS Hammerhead - PU - Ships / Ship Features / Interactions - Doors - The front interior airlock doors cannot be opened by the player when docked
...
# Feature Updates
Locations
- Increased Damage Output, Fire Rates, Fire Range, and greatly increased Health of Defense Turrets Around the PU


# Bug Fixes
- Fixed - PU - Mission Feature / AI - Melee takedown on NPC enemy doesn't count as kill
- Fixed - PU - Tractor Beam / Physics - When multiple players interact with the same cargo container using a Tractor Beam, those players' tractor beams may no longer work correctly on that container
- Fixed - Multivehicle - PU - Vehicles/ actor injury IFCS - T1 injury of passenger takes a seat in co-pilot or turret seat disables maneuvering of ship for the pilot
# Technical
