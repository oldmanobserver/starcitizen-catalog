**Title:** [All Waves PTU] Star Citizen Alpha 3.24.3 PTU.9421824 Patch Notes
**Date:** 2024-11-18
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/all-waves-ptu-star-citizen-alpha-3-24-3-ptu-942182
...
# **Features & Gameplay**
Tonight's build is a 3.24.3 LIVE Release Candidate for later this week. This build combines all the hotfixes that we have done over the weekend on the server and client.

This includes: 
- Multiple Server Crash fixes
- Vehicle Physics Performance Optimizations
- Further Fixes for Habitation Doors being Locked with a Red Line (STARC-126980)
- IAE Signage Updates