**Title:** Star Citizen Alpha 3.22.1 EPTU.9065683 Patch Notes
**Date:** 2024-02-14
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-22-1-eptu-9065683-patch-notes

---

# Star Citizen Patch 3.22.1
Alpha Patch 3.22.1 has been released and is now available to test!   Patch should now show: VERSION 3.22.1-EPTU.9065683.
...
-     New Overdrive Dynamic Event
We will be enabling the new Overdrive Dynamic Event tonight shortly after release to the EPTU and run overnight. This build should address most of the blockers that were stopping phase progression through waves 1-4 and hopefully allow players to get into phase 5. We are expecting player mission progression to save going into this build so you should be at the point in the phases that you ended during the previous build.
...
-     Fixed - PU - Vehicles - Combat - Exploit / Combat logging - Players can despawn their actor by quitting the game during combat
-     Dynamic Event Fix: PU - Stanton - Stage 3 - Missions / UI - Some AI are not counted towards the overall hostile counter of the mission
-     Dynamic Event Fix: PU - Stanton - Stage 3 - After completing Overdrive Initiative: Xenothreat incursion reset timer is inconsistent
-     Dynamic Event Fix: PU - Stanton - Stage 4 - Missions - The Kareah mission fails to complete at the last objective
-     Dynamic Event Fix: PU - Stanton - Stage 4 - Missions - There is no interaction to insert the Cryptokey on the mainframe at Kareah
-     Dynamic Event Fix: PU - Stanton - Stage 4 - Missions - After completing mission, it doesn't update in Contract Manager stopping progression

# Arena Commander Updates
-     Master Modes
- Reduced aim assist bullet nudging
