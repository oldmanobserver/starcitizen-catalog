**Title:** [All Waves PTU] Star Citizen Alpha 4.4 PTU 10694190 Patch Notes
**Date:** 2025-11-13
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-4-4-ptu-patch-notes-8

---

# Star Citizen Alpha Patch 4.4
Alpha Patch 4.4 has been released, and is now available to test!   Patch should now show: VERSION 4.4.0-PTU.10694190.
- Audience: All Waves
...
Vanduul-Tech Smugglers Mission rep requirements are temporarily reduced for PTU for testing
...
> Locations
**Nyx System Polish**
- Numerous Delemar/Levski/Vanduul-Tech Smuggler performance, lighting, art, audio, and LOD polish.
...
- Potential Fix: PU - Nyx - Vanduul-Tech - Mission / Audio / Dialogue - Voice comms calls appear to cut off early
- Potential Fix: PU - Missions / AI - DC - Remaining AI missing during Distribution Center FPS mission (STARC-180207)
- Potential Fix: PU - Nyx - Law / Locations - Criminal players killed by security response at Nyx stations respawn in the hospital rather than in prison
- Potential Fix: PU - Missions - ShipAmbush / Mercenary - Completing an Ambush-Eckhart mission will give Foxwell Enforcement Reputation instead of Eckhart Security Reputation
- Potential Fix: PU - Missions - Mercenary / AI - Some FPS AI is not spawning during missions
- Potential Fix: PU - Vanduul-Tech Smugglers - Mission Content / UI / mobiGlas - Repeatable Mission does not complete after finishing all objectives at a location that has since reset
