**Title:** Star Citizen Alpha 3.18.0 PTU.8384444 Patch Notes
**Date:** 2023-03-02
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-18-0-ptu-8384444-patch-notes

---

# Star Citizen Patch 3.18.0-PTU.8384444
Alpha Patch VERSION 3.18.0-PTU.8384444 has been released to the PTU, and is now available to test!
...
**Known Issues**
-     After returning to menu/relaunch into game, character customizer will open
- Klesher Inmate Worksuite in inventory after patch
...
# Bug Fixes
-     Fixed an issue causing cargo to become invisible in multiple ships after being purchased (This may not fully resolve the issue so please let us know in the regression thread!)
...
-     Fixed a major cause of low server performance introduced in the previous build