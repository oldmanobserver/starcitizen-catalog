**Title:** Star Citizen Alpha 3.18.1 PTU.8420577 Patch Notes
**Date:** 2023-03-28
**URL:** https://robertsspaceindustries.com/spectrum/community/SC/forum/190048/thread/star-citizen-alpha-3-18-1-ptu-8412394-patch-notes

---

# Star Citizen Patch 3.18.1 PTU-8420577
Alpha Patch 3.18.1 has been released to the PTU, and is now available to test!   Patch should now show: VERSION 3.18.1-PTU.8420577.
...
**Testing Focus**
```
This build has extra logging to help track down the large amount of delays we have been seeing when doing lots of interactions and actions in the PU
```
